 ...
 *  the stats page. The server page reads these and scopes its aggregations.
 *  A default trailing window applies when no params are set; "All time" clears
 *  the window explicitly via ?from=all. */
  ...
  return (
    <div className="flex flex-col gap-3 rounded-xl border border-border p-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
        <span className="text-sm text-muted-foreground sm:mr-1">Date range</span>
